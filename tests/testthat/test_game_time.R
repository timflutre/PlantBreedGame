  ...
  for (gameSessions_name in names(gameSessions)) {
    ...
    for (time_irl_name in names(time_irl_list)) {
      expect_equal(
        ...
        expected,
        label = paste("before start time, for time_irl", time_irl_name,
    ...
    for (time_irl_name in names(time_irl_list)) {
      expect_equal(
        ...
        expected,
        label = paste("exactly at start time, for time_irl", time_irl_name,
                      ", gameSessions", gameSessions_name)
      )
    }
  }
  ...
  for (gameSessions_name in names(gameSessions)) {
    ...
    for (time_irl_name in names(time_irl_list)) {
      expect_equal(
        ...
        expected,
        label = paste("after the end time, for time_irl", time_irl_name,
                      ", gameSessions", gameSessions_name)
      )
    }
    ...
    for (time_irl_name in names(time_irl_list)) {
      expect_equal(
        ...
        expected,
        label = paste("exactly at the end time, for time_irl", time_irl_name,
                      ", gameSessions", gameSessions_name)
      )
    }
  }
  ...
  for (gameSessions_name in names(gameSessions)) {
    ...
    for (time_irl_name in names(time_irl_list)) {
      expect_equal(
        ...
        expected,
        label = paste("between 2 sessions, for time_irl", time_irl_name,
                      ", gameSessions", gameSessions_name)
      )
    }
    ...
    for (time_irl_name in names(time_irl_list)) {
      expect_equal(
        ...
        expected,
        label = paste("exactly at the end of the 1st sessions, for time_irl", time_irl_name,
                      ", gameSessions", gameSessions_name)
      )
    }
    ...
    for (time_irl_name in names(time_irl_list)) {
      expect_equal(
        ...
        expected,
        label = paste("exactly at the start of the 2nd sessions, for time_irl", time_irl_name,
                      ", gameSessions", gameSessions_name)
      )
    }
  ...
  for (gameSessions_name in names(gameSessions)) {
    ...
    for (time_irl_name in names(time_irl_list)) {
      expect_equal(
        ...
        expected,
        label = paste("During 1st session, for time_irl", time_irl_name,
                      ", gameSessions", gameSessions_name)
      )
    }
    ...
    for (time_irl_name in names(time_irl_list)) {
      expect_equal(
        ...
        expected,
        label = paste("During 2nd session, for time_irl", time_irl_name,
                      ", gameSessions", gameSessions_name)
      )
    }
  }
...
test_that("getGameTime_empty_game_sessions", {
  ...
  empty_gameSessions = structure(list(id = numeric(0),
                                      start = numeric(0),
                                      end = numeric(0),
                                      year_time = numeric(0),
