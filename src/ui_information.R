...
tabItem(
  ...
  div(id="spec_bio",
      ...
      p(strong("Laboratory"), ": it can be used to perform haplodiploidisation (similar as for maize), and genotype samples on the various SNP chips.",
        " ", strong("Haplodiploidisation"), " has a ", strong(constants$duration.haplodiplo, "-month"), " delay and costs ", strong(constants$cost.haplodiplo, " plot"), " (", format(constants$cost.haplodiplo * constants$cost.pheno.field, digits=2), " Mendels).",
