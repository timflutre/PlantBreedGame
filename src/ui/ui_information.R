  ...
  fluidRow(
    ...
    shinydashboard::box(
      ...
      div(
        ...
        p(
          "The species is diploid, with ", constants$nb.chrs, " chromosomes, all of the same size (", format(constants$chr.length / 10^6, digits = 2), " Mb).",
        ...
        h2("Available data"),
        p(
          "These lines were planted and phenotyped on the only experimental site consisting of ", constants$nb.plots, " plots.",
        ...
        p(
          strong("Experimental site"), ": the only experimental site, Agrom-sur-Lez (AZ), has ", strong(constants$nb.plots, " plots."),
        ...
        h2("Final trial"),
        p(
          "At the end of the game, each team will have to propose to register their best genotypes (up to five).",
