...
output$selected_ind_info <- renderUI({
  ...
  offsprings <- rbind(db_get_individual(breeder = breeder(), parent1 = ind_id, public_columns = TRUE),
                  db_get_individual(breeder = breeder(), parent2 = ind_id, public_columns = TRUE))
